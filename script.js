...
//         headers: {
// 		'x-rapidapi-key': '372e5a4a1amshc7b37355aed4abdp1ce0eejsnd9871f43b6fe',
...
const handleCardClick = () => {
    window.open(`/video.html?id={videoId}`)
}
...
document.getElementById("myInput").addEventListener("change", function (event) {
    window.open(`./search.html?id=${event.target.value}`, "_top");
});
